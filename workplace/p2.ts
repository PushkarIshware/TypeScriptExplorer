// ***********************************************************************************
// * Purpose: Print proper templates.
// *
...
class RegExpression
{
    input()                                                     // input method for taking given values from user
    {
        try
        {
            console.log("Enter UserName:");
            var username:string = utility.input();
            if (username == "") throw "Username required...";

            console.log("Enter Full Name:");
            var full_name:string = utility.input();
            if (full_name == "") throw "full name required...";

            console.log("Enter Mobile Number:");
            var mobile : string = utility.input();
